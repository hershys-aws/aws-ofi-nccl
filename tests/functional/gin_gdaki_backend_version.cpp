 ...
 *
 * GDAKI backendVersion validation probe (NCCLOFI-1808).
 *
 ...
 *
 * Expected (only meaningful when built with --enable-gdaki):
...
int main(int argc, char *argv[])
{
	...
	fprintf(stderr, "backend_version: SKIP (built without --enable-gdaki)\n");
	return 0;
#else
